...
namespace SyaApi.DataAccessors
{
    public static class WorkAccessor
    {
        ...
        public static async Task<TakesItemEntity> FindOwnWork(int id)
        {
            ...
            var query = "SELECT student_id,work_id,work_time,absent_num,absent_time FROM takes WHERE student_id=@id";
        ...
        public static async Task<WorkEntity> FindWorkInfo(int id)
        {
            ...
            var query = "SELECT teacher_id,work_id,cover,work_description,address,salary,work_time,likes_num,collect_num,share_num FROM work WHERE work_id=@id";

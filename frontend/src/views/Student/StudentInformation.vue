    ...
    <el-card class="infoCard">
        ...
        <!--表单-->
            <el-form :model="UserInfo" label-width="0px" class="infoForm">
                <el-form-item class="itemRow">
                    <div class="itemNameContainer">
                        <p class="itemName"><i class="el-icon-phone-outline"></i> 绑定手机 ：</p>
                    </div>
                    <el-input class="infoItem" readonly="true" v-model="UserInfo.tel" ></el-input>
                </el-form-item>
                <el-form-item class="itemRow">
                    <div class="itemNameContainer">
                        <p class="itemName"><i class="el-icon-message"></i> 邮箱 :</p>
                    </div>
                    <el-input class="infoItem" readonly="true" v-model="UserInfo.email" ></el-input>
                </el-form-item>
                 <el-form-item class="itemRow">
                    <div class="itemNameContainer">
                        <p class="itemName"><i class="el-icon-bank-card"></i> 银行卡号 :</p>
                    </div>
                    <el-input class="infoItem" readonly="true" v-model="UserInfo.bank" ></el-input>
                </el-form-item>
            </el-form>
        </el-row>
        <!--信息标题-->
        ...
        <!--表单-->
            <el-form :model="UserInfo" label-width="0px" class="infoForm">
                <el-form-item class="itemRow">
                    ...
                    <el-input class="infoItem" readonly="true" v-model="UserInfo.work_time" ></el-input>
                </el-form-item>
                <el-form-item class="itemRow">
                    <div class="itemNameContainer">
                        <p class="itemName"><i class="el-icon-document"></i> 申请总次数 :</p>
                    </div>
                    <el-input class="infoItem" readonly="true" v-model="UserInfo.nof_apply" ></el-input>
                </el-form-item>
                <el-form-item class="itemRow">
                    <div class="itemNameContainer">
                        <p class="itemName"><i class="el-icon-document-delete"></i> 请假总次数 :</p>
                    </div>
                    <el-input class="infoItem" readonly="true" v-model="UserInfo.nof_absent" ></el-input>
                </el-form-item>
                <el-form-item class="itemRow">
                    <div class="itemNameContainer">
                        <p class="itemName"><i class="el-icon-help"></i> 累积总收入 :</p>
                    </div>
                    <el-input class="infoItem" readonly="true" v-model="UserInfo.income" ></el-input>
                </el-form-item>
            </el-form>  
        </el-row> 

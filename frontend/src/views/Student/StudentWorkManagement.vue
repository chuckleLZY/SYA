<template>
  <div>
    ...
    <el-card class="workCard" v-loading="loading">
      ...
      <el-row :gutter="30">
        <el-col :span="7">
          <el-input placeholder="请输入工作名称" v-model="queryInfo.query" clearable @clear="getWorklist()">
            <el-button
              slot="append"
              icon="el-icon-search"
              @click="getWorklist()"
      ...
      <el-row style="margin-top:1cm">
        <el-table :data="Worklist" border>
          ...
          <el-table-column prop="address" label="工作地址"> </el-table-column>
          <el-table-column prop="salary" label="工作薪水"> </el-table-column>
            ...
            <template slot-scope="scope">
              <el-button
                ...
                @click="
                  ...
                  AbsentVisible = true;
                  workstart = scope.row.start_day;
                  workend = scope.row.end_day;
                  startTime = scope.row.start_time;
                  endTime = scope.row.end_time;
                  workDay = scope.row.week_day;
                "
                >申请请假</el-button
              >
              <el-button
    ...
    <!--辞职对话框-->
    <el-dialog title="提示" :visible.sync="resignVisible" width="30%" center>

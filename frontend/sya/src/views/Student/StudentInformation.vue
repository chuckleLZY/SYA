<template>
  <div> 
    ...
    <!--个人资料卡片-->
    <el-card class="infoCard" v-if="cardVisible==true">
        <el-row>
            <el-col :span="5">
        ...
        <div class='box' id='box2'> </div>
            <el-row class="avaRow">
                <el-avatar shape="circle" :size="100" src="https://empty">
    ...
    methods:{
        ...
        saveedit(){
             this.$refs.editRef.validate(async valid =>{   
                ...
                const {data: res} = await axios.post('http://localhost:5000/User/UpdateUser',this.editForm,{ withCredentials: true });
                if (res.status > 400) {

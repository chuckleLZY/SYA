  ...
  <div> 
    ...
    <el-card class="infoCard">
        ...
        <div style="text-align:center">
            <p class="syaSup"><el-button type="primary" icon="el-icon-edit" @click="UpdateUser()">点击修改</el-button></p>
...
export default {
    ...
    methods:{
        ...
        async UpdateUser(){
            const {data: ccc} = await axios.post('http://localhost:5000/User/GetUserInfo',{},{ withCredentials: true });
            this.UserInfo=ccc;
            ...
            const {data: res} = await axios.post('http://localhost:5000/User/UpdateUser',
            {
              gender: true,
              avatar: "a.png",
              tel: this.phone,
